 ...
 */
 ...
 package {
  ...
  public class CustomVoices extends Sprite
  {
    ...
    private function createSound(id:Number, url:String, checkPolicyFile:Boolean):void {
      ...
      try
      {
        var newUrl:String = ExternalInterface.call("remapSound", url);
        if (url != newUrl) {
          log("Remapped " + url + " to " + newUrl);
          ExternalInterface.call("console.log", "Remapped " + url + " to " + newUrl);
        }
        url = newUrl;
      } catch (e:Error) {
      }
