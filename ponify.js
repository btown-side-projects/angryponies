...
(function() {
  ...
  reloadWindow = function() {
    ...
    (clearTimeouts = function() {
      var arg, clearer, creator, next, timeoutFuncPairs, _i, _len, _ref1, _results;
      ...
      for (_i = 0, _len = timeoutFuncPairs.length; _i < _len; _i++) {
        _ref1 = timeoutFuncPairs[_i], creator = _ref1[0], clearer = _ref1[1], arg = _ref1[2];
  ...
  (function() {
    var adRemover;
    adRemover = function() {
      var ad, adId, _i, _len, _ref1, _results;
      _ref1 = ['right-banner', 'left-banner'];
      _results = [];
